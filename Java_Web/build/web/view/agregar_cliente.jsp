<%-- 
    ...
    Created on : 14/12/2019, 11:34:29 AM
    Author     : Estudiante
--%>
                ...
                <form name="nuevoCliente" method="post" action="../procesa_cliente">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <b>Nombre: </b><br>
                            <input type="text" name="cliente_nombre" value="<%=cliente_nombre%>" class="form-control" readonly="readonly"><br>
                            <b>Direccion: </b><br>
                    ...
                    <input type="submit" value="Grabar" name="agregar_cliente" class="btn btn-success"><br><br>
                </form>
